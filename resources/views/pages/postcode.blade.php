<x-app>
    <form method="POST" action="{{route('pages.postcode.store')}}" class="mb-8">
        ...
        <div class="mb-4">
            ...
            <div class="mt-2">
                <input type="text" name="postcode" id="postcode" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="SE1 1UN" />
            </div>
        </div>
